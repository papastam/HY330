...
class basic_filtering(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic Filtering", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic Filtering")
        ...
        self.settings = Qt.QSettings("GNU Radio", "basic_filtering")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 30e3, 60e3, 1e3, window.WIN_HAMMING, 6.76))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)
        self.blocks_throttle_1.set_sample_rate(self.samp_rate)
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 20e3, 1e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=basic_filtering, options=None):
