...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, (samp_rate//bit_rate))
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(1, gr.GR_MSB_FIRST)
        self.blocks_char_to_float_0_0 = blocks.char_to_float(1, 1)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.analog_const_source_x_0 = analog.sig_source_b(0, analog.GR_CONST_WAVE, 0, 0, 0x55)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_packed_to_unpacked_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_repeat_0.set_interpolation((self.samp_rate//self.bit_rate))
