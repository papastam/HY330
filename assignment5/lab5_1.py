...
class lab5_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_1")
        ...
        labels = ['Without Shaping', 'With Shaping', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(amplitude)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(mod_index)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, c_freq, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 1.0, 0.35, 5))
    ...
    def set_c_freq(self, c_freq):
        self.c_freq = c_freq
        self.analog_sig_source_x_0.set_frequency(self.c_freq)
    ...
    def set_amplitude(self, amplitude):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(self.amplitude)




def main(top_block_cls=lab5_1, options=None):
