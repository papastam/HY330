...
class lab0_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab0_2")
        ...
        labels = ['Sine', 'Triangle', 'Sawtooth', 'Square', 'Signal 5',
        ...
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 4000, 4, 0, 0)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 3000, 3, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 2000, 2, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_throttle_0_1, 0))
        self.connect((self.analog_sig_source_x_1_0_0, 0), (self.blocks_throttle_0_1_0, 0))
        ...
        self.connect((self.blocks_throttle_0_1_0, 0), (self.qtgui_time_sink_x_0, 3))
...
def main(top_block_cls=lab0_2, options=None):
