...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.range_selection = range_selection = 1000

        ##################################################
        # Blocks
        ##################################################

        self._range_selection_range = Range(1000, 10000, 1, 1000, 200)
        self._range_selection_win = RangeWidget(self._range_selection_range, self.set_range_selection, "'range_selection'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._range_selection_win)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, range_selection, 1, 0, 0)
    ...
    def set_range_selection(self, range_selection):
        self.range_selection = range_selection
        self.analog_sig_source_x_0_0.set_frequency(self.range_selection)
