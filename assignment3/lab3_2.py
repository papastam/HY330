...
class lab3_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq = freq = 1000
        self.final_samp_rate = final_samp_rate = 62400

        ##################################################
        # Blocks
        ##################################################

        self._freq_range = Range(0, 24000, 1000, 1000, 200)
        ...
        self.analog_const_source_x_0_0_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 2)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.low_pass_filter_0_0_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_divide_xx_0_0, 0))
        self.connect((self.blocks_add_xx_0_0_0, 0), (self.blocks_divide_xx_0_0_0, 0))
        self.connect((self.blocks_deinterleave_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_deinterleave_0, 0), (self.blocks_null_sink_0, 1))
        self.connect((self.blocks_deinterleave_0, 2), (self.low_pass_filter_0_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_delay_0, 0), (self.blocks_add_xx_0_0_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_interleave_0, 0))
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_add_xx_0_0, 0))
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_add_xx_0_0_0, 1))
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_interleave_0, 2))
        self.connect((self.blocks_divide_xx_0_0, 0), (self.blocks_interleave_0, 3))
        self.connect((self.blocks_divide_xx_0_0_0, 0), (self.blocks_interleave_0, 1))
        self.connect((self.blocks_interleave_0, 0), (self.blocks_deinterleave_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_add_xx_0_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 24000, 10, window.WIN_HAMMING, 6.76))
    ...
    def set_final_samp_rate(self, final_samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.final_samp_rate, 24000, 10, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.final_samp_rate)
