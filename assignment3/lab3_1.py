...
class lab3_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['+ 0', '+ Last', '+ Avg', '+ Average', 'Signal 5',
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_interleave_0, 1))
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_interleave_0_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_interleave_0_0_0, 1))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_divide_xx_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_interleave_0_0, 1))
        self.connect((self.blocks_delay_0_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_interleave_0_0_0, 0))
        self.connect((self.blocks_interleave_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_interleave_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_interleave_0_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.blocks_interleave_0_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_interleave_0_0_0, 0), (self.qtgui_freq_sink_x_0, 2))
        self.connect((self.blocks_interleave_0_0_0, 0), (self.qtgui_time_sink_x_0, 2))
